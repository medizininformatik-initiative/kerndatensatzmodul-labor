# Laboratory report: creatinine - MII IG Laborbefund v2027.0.0-ballot

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **Laboratory report: creatinine**

## Beispiel DiagnosticReport: Laboratory report: creatinine
...
Profile: [MII PR Labor Laborbefund](StructureDefinition-mii-pr-labor-laborbefund.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/core/modul-labor/StructureDefinition/DiagnosticReportLab|2027.0.0-ballot"],
    "security" : [{
