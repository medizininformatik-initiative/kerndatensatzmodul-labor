# Laboratory result: creatinine without a value (Data Absent Reason) - MII IG Laborbefund v2027.0.0-ballot

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **Laboratory result: creatinine without a value (Data Absent Reason)**

## Beispiel Observation: Laboratory result: creatinine without a value (Data Absent Reason)
...
Profile: [MII PR Labor Laboruntersuchung](StructureDefinition-mii-pr-labor-laboruntersuchung.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/core/modul-labor/StructureDefinition/ObservationLab|2027.0.0-ballot"],
    "security" : [{
