# MII PR Labor Laborbefund - MII IG Laborbefund v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Labor Laborbefund**

## Resource Profile: MII PR Labor Laborbefund 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-labor/StructureDefinition/DiagnosticReportLab | *Version*:2027.0.0-ballot.rc1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.laborbefund|current/StructureDefinition/StructureDefinition-mii-pr-labor-laborbefund.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-labor-laborbefund.csv), [Excel](../StructureDefinition-mii-pr-labor-laborbefund.xlsx), [Schematron](../StructureDefinition-mii-pr-labor-laborbefund.sch) 
