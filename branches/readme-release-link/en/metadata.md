# Metadata Overview - MII IG Laborbefund v2027.0.0-ballot.rc1
...
The metadata is visible in the JSON and XML of every artifact page, and in the [package](downloads.md). It is descriptive: it does not change what a profile requires. The manifest parameters are the exception — they shape expansion and validation, and therefore the generated output.
