The [MII Laboratory Request profile](StructureDefinition-mii-pr-labor-laboranforderung.html) — ServiceRequestLab — represents the order for a laboratory test.
