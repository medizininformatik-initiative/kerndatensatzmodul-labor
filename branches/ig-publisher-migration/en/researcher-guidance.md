# Guidance for Researchers - MII IG Laborbefund v2027.0.0
...
The [Logical Models](logical-models.md) provide a high-level, technology-independent description of the data this module covers:
...
The [UML Diagrams](uml-diagrams.md) show how the elements relate to one another. They are particularly useful for:
