...
`Observation.interpretation` ist extensible an das ValueSet [Interpretation](ValueSet-mii-vs-labor-interpretation.md) gebunden – eine eingeschränkte Auswahl aus HL7 v3 ObservationInterpretation:
