...
FHIR bindet `Observation.interpretation` extensible an [Observation Interpretation Codes](http://hl7.org/fhir/ValueSet/observation-interpretation), das den vollständigen CodeSystem HL7 v3 ObservationInterpretation umfasst. Das Modul schränkt diese Auswahl auf die im Laborkontext häufigsten Konzepte ein und bindet – ebenfalls extensible – an das ValueSet [Interpretation](ValueSet-mii-vs-labor-interpretation.md):
