# Änderungen - MII IG Laborbefund v2027.0.0-ballot.rc4
...
* Alle Profile, ValueSets, das CapabilityStatement und die ImplementationGuide-Ressource tragen CRMI-Metadaten (Shareable, Publishable, ValueSets zusätzlich Computable) samt Freigabe- und Reviewdatum, Gültigkeitszeitraum, Versionspolicy, Package-Herkunft und Beitragenden. Siehe [Metadatenübersicht](metadata.md).
...
* Neue Seite [Interpretation](interpretation.md): welche Codes für die Bewertung eines Ergebnisses vorgesehen sind, wie lokale Skalen darauf abbilden und wann die abnormal-Codes in Frage kommen.
* Die Modulbeschreibung ist nach Themen aufgeteilt: [Zeitpunkte im Labor](laboratory-timestamps.md), [Interpretation](interpretation.md) und [Probenmaterial](specimen.md) sind eigene Seiten.
