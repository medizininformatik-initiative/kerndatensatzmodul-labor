...
The codes that apply to `Observation.interpretation`, and how local scales map onto them, are explained under [Interpretations and Comments](interpretation.html).
