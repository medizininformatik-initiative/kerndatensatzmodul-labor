...
* interpretation ^binding.description = "Eingeschränkte Auswahl aus HL7 v3 ObservationInterpretation. Lokale Kodierungen wie -- - N + ++ oder L N H lassen sich auf diese Konzepte abbilden. Die Bindung ist extensible: zum Beispiel für Werte jenseits der Telefongrenze können aus dem v3-ObservationInterpretation ValueSet zusätzlich die abnormal-Codes HH, LL und AA verwendet werden."
* insert Translation(interpretation ^binding.description, de-DE, [[Eingeschränkte Auswahl aus HL7 v3 ObservationInterpretation. Lokale Kodierungen wie -- - N + ++ oder L N H lassen sich auf diese Konzepte abbilden. Die Bindung ist extensible: zum Beispiel für Werte jenseits der Telefongrenze können aus dem v3-ObservationInterpretation ValueSet zusätzlich die abnormal-Codes HH, LL und AA verwendet werden.]])
* insert Translation(interpretation ^binding.description, en-US, [[Restricted selection from HL7 v3 ObservationInterpretation. Local codings such as -- - N + ++ or L N H can be mapped onto these concepts. The binding is extensible: for example, for values beyond the critical notification limit the abnormal codes HH, LL and AA from the v3-ObservationInterpretation ValueSet may additionally be used.]])
* note MS
  * ^short = "Hinweis"
