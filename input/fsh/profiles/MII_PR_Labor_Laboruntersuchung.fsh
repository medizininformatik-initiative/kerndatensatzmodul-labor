...
* category
  * coding MS
    ...
    * code 1.. MS
    * display MS
// Siehe das Laborbefund-Profil: ein Slice, ein Coding im Pattern, offen.
* category ^slicing.discriminator.type = #pattern
* category ^slicing.discriminator.path = "$this"
* category ^slicing.rules = #open
* category contains observation-category 1..1 MS
* category[observation-category] = $observation-category#laboratory
* category[observation-category] ^short = "Labor-Kategorie"
* category[observation-category] ^definition = "Die verpflichtende Kategorie der Laboruntersuchung. Weitere Codings im selben Eintrag und weitere category-Eintraege sind zulaessig."
* code MS
  * ^short = "Code"
